          ...
          <div className="bg-white rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <div className="p-6 md:p-8 overflow-y-auto flex-grow">
              ...
              <div>
                ...
                <div 
                  className="prose prose-sm md:prose-base max-w-none prose-a:text-primary prose-headings:text-gray-900 prose-p:text-gray-700 bg-gray-50 p-6 rounded-xl border border-gray-100"
