...
export default function BlogCard({ blog }: { blog: Blog }) {
  ...
  return (
    <article className="bg-primary/5 rounded-md shadow-sm border border-gray-100 hover:border-primary hover:shadow-md transition-all overflow-hidden flex flex-col h-full group">
